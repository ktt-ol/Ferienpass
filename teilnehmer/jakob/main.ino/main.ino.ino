...
void rosaLEDs() {
  for(int i=0;i<25;i++) {
    pixels.setPixelColor(i, pixels.Color(255,0,200));  // Rosa        
    pixels.setBrightness(10); // Helligkeit
    pixels.show(); // This sends the updated pixel color to the hardware.
    delay(100);
  } 
...
void tuerkisLEDs() {
  for(int i=0;i<25;i++) {
    pixels.setPixelColor(i, pixels.Color(255,0,200));  // Tuerkis        
    pixels.setBrightness(10); // Helligkeit
    pixels.show(); // This sends the updated pixel color to the hardware.
    delay(100);
  } 
...
void ampLEDs(int amp)  {
  ...
  for(int i=0;i<25;i++) {
    pixels.setPixelColor(i, pixels.Color(amp,255,188));        
    pixels.setBrightness(10); // Helligkeit
    pixels.show(); // This sends the updated pixel color to the hardware.
    delay(100);
  } 
...
void showBME() {
    ...
    else if(sensor.getTemperature() > 0 && sensor.getTemperature() < 10) {
      blaueLEDs();
    }
    else if(sensor.getTemperature() >= 10 && sensor.getTemperature() <= 20) {
      rosaLEDs();
    }
    else {
      roteLEDs();
